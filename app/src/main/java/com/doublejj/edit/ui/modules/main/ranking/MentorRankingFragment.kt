...
import com.doublejj.edit.databinding.FragmentMentorRankingBinding
import com.doublejj.edit.ui.utils.snackbar.CustomSnackbar
import com.google.android.material.snackbar.Snackbar

class MentorRankingFragment : Fragment(), UserRankingView {
    private lateinit var binding: FragmentMentorRankingBinding
    private val role = "MENTOR"
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(inflater, R.layout.fragment_mentor_ranking, container, false)
    ...
    override fun onGetUserRankingSuccess(response: RankingResponse) {
        if (response.isSuccess) {
            ...
            if (rankerList.size == 0) {
                return // do nothing
            }

            if (rankerList.size >= 4) {
                // set values into rv
